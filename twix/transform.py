...
def transform(pdf_paths, result_folder_path, LLM_model_name):
    total_cost = 0
    phrases, cost = extract.extract_phrase(pdf_paths, result_folder_path, LLM_model_name=LLM_model_name)
    total_cost += cost 
